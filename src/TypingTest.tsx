...
export default function TypingTest() {
  ...
  return (
    <div className="w-[480px] bg-gray-900 text-white shadow-lg overflow-hidden flex flex-col">
      ...
      <main className="p-4 flex-grow">
        {!isFinished && !showHistory && (
          <>
            <div className="mb-4 h-24 overflow-hidden">
              <p className="text-gray-400 text-sm mb-1">Type the following:</p>
              <p
            ...
            <input
              ref={inputRef}
              className="w-full p-2 text-sm border rounded mb-3 bg-gray-800 text-white border-gray-700 focus:outline-none"
              value={userInput}
        ...
        {(isFinished || showHistory) && (
          <>
            ...
            {!showHistory && results.length > 0 && (
              <div className="bg-gray-800 p-3 rounded mb-3 text-sm max-h-64 overflow-y-auto">
        ...
        <div className="flex space-x-2">
          <button
            className="flex-1 bg-red-600 text-white px-3 py-2 rounded text-sm font-medium hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 transition duration-200 ease-in-out flex items-center justify-center"
            onClick={resetTest}
          ...
          <button
            className="flex-1 bg-blue-600 text-white px-3 py-2 rounded text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-200 ease-in-out flex items-center justify-center"
